...
- [Задание 3: Создание Cloud Router](#задание-3-создание-cloud-router)
- [Задание 4: Настройка Cloud NAT](#задание-4-настройка-cloud-nat)
- [Задание 5: Исследование NAT — порты, лимиты, поведение](#задание-5-исследование-nat--порты-лимиты-поведение)
- [Задание 6: NAT-логи и мониторинг](#задание-6-nat-логи-и-мониторинг)
...
Перед выполнением лабораторной работы рекомендуется ознакомиться с теорией о глобальных сетях и протоколах взаимодействия в [Теоретическом конспекте](../abstract1/README.md).
