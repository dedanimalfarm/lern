...
Перед выполнением лабораторной работы рекомендуется ознакомиться с разделами о сетевых интерфейсах, MAC-адресах, ARP и свойствах интерфейсов в [Теоретическом конспекте](../abstract1/README.md).
