...
- [Часть 1: OCI-bundle и config.json](#часть-1-oci-bundle-и-configjson)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Собрать bundle и сгенерировать config.json](#11-собрать-bundle-и-сгенерировать-configjson)
- [Часть 2: Запуск через runc run](#часть-2-запуск-через-runc-run)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Запустить контейнер](#21-запустить-контейнер)
- [Часть 3: Жизненный цикл и связь с Docker](#часть-3-жизненный-цикл-и-связь-с-docker)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 Пошаговый запуск](#31-пошаговый-запуск)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: `runc run failed: open /dev/tty` (terminal=true без tty)](#инцидент-1-runc-run-failed-open-devtty-terminaltrue-без-tty)
