...
- [Часть 1: MAC vs DAC и устройство AppArmor](#часть-1-mac-vs-dac-и-устройство-apparmor)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Посмотреть загруженные профили](#11-посмотреть-загруженные-профили)
- [Часть 2: Профиль в enforce — блокировка даже для root](#часть-2-профиль-в-enforce--блокировка-даже-для-root)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Запуск под enforce-профилем](#21-запуск-под-enforce-профилем)
- [Часть 3: Режим complain и отладка](#часть-3-режим-complain-и-отладка)
...
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  ...
  - [Инцидент 1: профиль в complain не блокирует](#инцидент-1-профиль-в-complain-не-блокирует)
