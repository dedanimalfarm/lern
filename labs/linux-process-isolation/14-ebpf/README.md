...
- [Часть 1: Перехватить openat (IDS-стиль)](#часть-1-перехватить-openat-ids-стиль)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Слежка за открытием файла](#11-слежка-за-открытием-файла)
- [Часть 2: Агрегаты — кто сколько syscalls делает](#часть-2-агрегаты--кто-сколько-syscalls-делает)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Сколько syscalls у каждого процесса](#21-сколько-syscalls-у-каждого-процесса)
- [Часть 3: eBPF в контейнерном мире](#часть-3-ebpf-в-контейнерном-мире)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 Привязка события к процессу](#31-привязка-события-к-процессу)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: `bpftrace ... only supports running as the root user`](#инцидент-1-bpftrace--only-supports-running-as-the-root-user)
