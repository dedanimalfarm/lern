...
- [Часть 1: Механика pivot_root](#часть-1-механика-pivot_root)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 pivot_root в новом mount-namespace](#11-pivot_root-в-новом-mount-namespace)
- [Часть 2: Закрываем побег из модуля 01](#часть-2-закрываем-побег-из-модуля-01)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Побег теперь упирается в наш корень (CONFINED)](#21-побег-теперь-упирается-в-наш-корень-confined)
- [Часть 3: Troubleshooting](#часть-3-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: `pivot_root: ... Device or resource busy`](#инцидент-1-pivot_root--device-or-resource-busy)
