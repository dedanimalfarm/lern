...
- [Часть 1: Собрать overlay из слоёв](#часть-1-собрать-overlay-из-слоёв)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 mount -t overlay](#11-mount--t-overlay)
- [Часть 2: Copy-on-Write — запись не трогает lower](#часть-2-copy-on-write--запись-не-трогает-lower)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Правка файла из lower](#21-правка-файла-из-lower)
- [Часть 3: Whiteout и multi-layer](#часть-3-whiteout-и-multi-layer)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 Whiteout при удалении](#31-whiteout-при-удалении)
  - [3.2 Несколько слоёв (как образ из нескольких RUN)](#32-несколько-слоёв-как-образ-из-нескольких-run)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: `workdir and upperdir must reside under the same mount`](#инцидент-1-workdir-and-upperdir-must-reside-under-the-same-mount)
