...
- [Часть 1: Что делает mycontainer](#часть-1-что-делает-mycontainer)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Запустить контейнер](#11-запустить-контейнер)
- [Часть 2: Главный тезис — pivot_root делает контейнер контейнером](#часть-2-главный-тезис--pivot_root-делает-контейнер-контейнером)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Побег закрыт (сравните с этапом 01)](#21-побег-закрыт-сравните-с-этапом-01)
- [Часть 3: Лимиты ресурсов и честные ограничения](#часть-3-лимиты-ресурсов-и-честные-ограничения)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 Лимит памяти защищает хост](#31-лимит-памяти-защищает-хост)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: наивный chroot-контейнер дырявый (побег на хост)](#инцидент-1-наивный-chroot-контейнер-дырявый-побег-на-хост)
