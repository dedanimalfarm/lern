...
- [Часть 1: veth pair — прямая связь двух namespace](#часть-1-veth-pair--прямая-связь-двух-namespace)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Соединить alpha ↔ beta](#11-соединить-alpha--beta)
- [Часть 2: bridge — несколько контейнеров в одной сети](#часть-2-bridge--несколько-контейнеров-в-одной-сети)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Подключить alpha/beta/gamma к мосту](#21-подключить-alphabetagamma-к-мосту)
- [Часть 3: NAT — выход во внешний мир](#часть-3-nat--выход-во-внешний-мир)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 Дать alpha выход в интернет](#31-дать-alpha-выход-в-интернет)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: ping не идёт — интерфейс DOWN](#инцидент-1-ping-не-идёт--интерфейс-down)
