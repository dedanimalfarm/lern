...
- [Часть 1: Стать root внутри user namespace](#часть-1-стать-root-внутри-user-namespace)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 root внутри, обычный пользователь снаружи](#11-root-внутри-обычный-пользователь-снаружи)
- [Часть 2: Доказательство — «root» внутри = обычный uid снаружи](#часть-2-доказательство--root-внутри--обычный-uid-снаружи)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Файл от root внутри принадлежит nobody на хосте](#21-файл-от-root-внутри-принадлежит-nobody-на-хосте)
- [Часть 3: От «фейкового root» к настоящему rootless-контейнеру](#часть-3-от-фейкового-root-к-настоящему-rootless-контейнеру)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 Single-uid ограничение](#31-single-uid-ограничение)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: внутри user-ns ты не root (забыт `-r`)](#инцидент-1-внутри-user-ns-ты-не-root-забыт--r)
