...
- [Часть 1: Минимальный rootfs и вход в chroot](#часть-1-минимальный-rootfs-и-вход-в-chroot)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Собрать rootfs и войти](#11-собрать-rootfs-и-войти)
- [Часть 2: Что chroot НЕ изолирует](#часть-2-что-chroot-не-изолирует)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 PID, UTS, сеть, mount-ns — всё хостовое](#21-pid-uts-сеть-mount-ns--всё-хостовое)
- [Часть 3: Классический побег через /proc/1/root](#часть-3-классический-побег-через-proc1root)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 Сбежать в корень хоста](#31-сбежать-в-корень-хоста)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: «No such file or directory» на существующем бинаре](#инцидент-1-no-such-file-or-directory-на-существующем-бинаре)
