...
- [Часть 1: Что такое capability и где она живёт](#часть-1-что-такое-capability-и-где-она-живёт)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Посмотреть свои capabilities](#11-посмотреть-свои-capabilities)
- [Часть 2: File capabilities — одна привилегия бинарю](#часть-2-file-capabilities--одна-привилегия-бинарю)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 nobody биндит :80 только с CAP_NET_BIND_SERVICE](#21-nobody-биндит-80-только-с-cap_net_bind_service)
- [Часть 3: Обрезать привилегии — процесс с одной cap](#часть-3-обрезать-привилегии--процесс-с-одной-cap)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 nobody ровно с одной привилегией (CAP_CHOWN)](#31-nobody-ровно-с-одной-привилегией-cap_chown)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: `setcap +p` вместо `+ep` — привилегия не действует](#инцидент-1-setcap-p-вместо-ep--привилегия-не-действует)
