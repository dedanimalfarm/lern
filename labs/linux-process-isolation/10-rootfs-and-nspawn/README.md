...
- [Часть 1: Собрать rootfs](#часть-1-собрать-rootfs)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью)
  - [1.1 Скачать alpine minirootfs](#11-скачать-alpine-minirootfs)
- [Часть 2: Запустить через systemd-nspawn](#часть-2-запустить-через-systemd-nspawn)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-1)
  - [2.1 Запуск alpine](#21-запуск-alpine)
- [Часть 3: Что nspawn делает за тебя + debootstrap](#часть-3-что-nspawn-делает-за-тебя--debootstrap)
  - [Теория для изучения перед частью](#теория-для-изучения-перед-частью-2)
  - [3.1 (опц.) Собрать Ubuntu-rootfs через debootstrap](#31-опц-собрать-ubuntu-rootfs-через-debootstrap)
- [Часть 4: Troubleshooting](#часть-4-troubleshooting)
  - [Теория: диагностика по симптому](#теория-диагностика-по-симптому)
  - [Инцидент 1: nspawn отказывается — «doesn't look like an OS tree»](#инцидент-1-nspawn-отказывается--doesnt-look-like-an-os-tree)
