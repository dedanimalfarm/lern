...
```text
Single-stage:   [golang:1.26]  →  образ ~900 MB (SDK + исходники + бинарник)
Multi-stage:    [golang:1.26]  →  [distroless]  →  образ ~8 MB (только бинарник)
```
...
# go version go1.26... — SDK в production-образе
