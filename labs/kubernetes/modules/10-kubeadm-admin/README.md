...
- [Часть 3: Сертификаты и kubeconfig](#часть-3-сертификаты-и-kubeconfig)
  ...
  - [3.1 Архитектура PKI в Kubernetes](#31-архитектура-pki-в-kubernetes)
  - [3.2 Проверка сроков действия сертификатов](#32-проверка-сроков-действия-сертификатов)
  - [3.3 Продление сертификатов (renew)](#33-продление-сертификатов-renew)
...
В архитектуре kubeadm ключевые компоненты control-plane (`kube-apiserver`, `etcd`,
