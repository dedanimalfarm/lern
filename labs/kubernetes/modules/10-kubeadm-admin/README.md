...
- [Стартовая проверка](#-)
- [Часть 1: Обслуживание ноды — cordon / drain / uncordon](#-1----cordon--drain--uncordon)
  - [Теория для изучения перед частью](#----)
  - [1.1 cordon → drain → uncordon](#11-cordon--drain--uncordon)
  - [1.2 PDB защищает доступность](#12-pdb--)
- [Часть 2: Control-plane как static pods](#-2-control-plane--static-pods)
  - [Теория для изучения перед частью](#----)
- [Часть 3: Сертификаты и kubeconfig](#-3---kubeconfig)
  - [Теория для изучения перед частью](#----)
