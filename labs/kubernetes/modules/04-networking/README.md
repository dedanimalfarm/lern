...
> ⏱ время ~60 мин · сложность 3/5 · пререквизиты: модуль 03

<!-- NAV -->
**⬅ [03-workloads](../03-workloads/)** · [индекс курса](../../README.md) · [карта обучения](../../docs/02-learning-path.md) · **[05-storage](../05-storage/) ➡**
<!-- /NAV -->
