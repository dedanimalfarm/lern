...
> ⏱ время ~60 мин · сложность 1/5 · пререквизиты: базовое знание Linux и Docker

<!-- NAV -->
**⬅ начало** · [индекс курса](../../README.md) · [карта обучения](../../docs/02-learning-path.md) · **[02-pods-lifecycle](../02-pods-lifecycle/) ➡**
<!-- /NAV -->
