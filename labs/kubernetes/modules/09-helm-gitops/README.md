...
- [Стартовая проверка](#-)
- [Часть 1: Helm chart](#-1-helm-chart)
  - [Теория для изучения перед частью](#----)
  - [1.1 Lint и рендер](#11-lint--)
  - [1.2 Установка release](#12--release)
  - [1.3 Переопределение values](#13--values)
- [Часть 2: GitOps и Argo CD](#-2-gitops--argo-cd)
  - [Теория для изучения перед частью](#----)
...
2. Зашифрованный файл безопасно коммитится в Git.
...
В нашей лаборатории Argo CD плагины для SOPS не настроены, поэтому мы не будем выполнять деплой, но вы можете найти пример зашифрованного манифеста в `charts/demo-app/templates/secrets.enc.yaml`. В реальной практике этот файл шифруется с помощью команды:
```bash
