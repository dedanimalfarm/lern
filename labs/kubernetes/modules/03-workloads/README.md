...
> ⏱ время ~60 мин · сложность 2/5 · пререквизиты: модуль 02

<!-- NAV -->
**⬅ [02-pods-lifecycle](../02-pods-lifecycle/)** · [индекс курса](../../README.md) · [карта обучения](../../docs/02-learning-path.md) · **[04-networking](../04-networking/) ➡**
<!-- /NAV -->
