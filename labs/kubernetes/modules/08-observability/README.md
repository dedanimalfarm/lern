...
- [Стартовая проверка](#-)
- [Часть 1: Events и Conditions](#-1-events--conditions)
  - [Теория для изучения перед частью](#----)
  - [1.1 Events и Conditions](#11-events--conditions)
- [Часть 2: Логи](#-2-)
  - [Теория для изучения перед частью](#----)
  - [2.1 Структурированные логи](#21--)
  - [2.2 Логи упавшего контейнера](#22---)
- [Часть 3: Метрики (metrics-server, kubectl top)](#-3--metrics-server-kubectl-top)
  - [Теория для изучения перед частью](#----)
  - [3.1 kubectl top](#31-kubectl-top)
- [Часть 4: Troubleshooting и runbook](#-4-troubleshooting--runbook)
  - [Теория: каталог состояний пода + механика back-off](#------back-off)
  - [Инцидент 1: `CrashLoopBackOff`](#-1-crashloopbackoff)
  - [Бонус: линейный runbook деградации](#--runbook-)
- [Проверка модуля](#-)
