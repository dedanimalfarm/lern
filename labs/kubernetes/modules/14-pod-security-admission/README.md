...
- [Стартовая проверка](#-)
- [Часть 1: Pod Security Admission (PSA)](#-1-pod-security-admission-psa)
  - [Теория для изучения перед частью](#----)
  - [1.1 restricted: good проходит, bad отклоняется](#11-restricted-good--bad-)
- [Часть 2: ValidatingAdmissionPolicy (CEL)](#-2-validatingadmissionpolicy-cel)
  - [Теория для изучения перед частью](#----)
  - [2.1 Запрет :latest](#21--latest)
- [Часть 3: Policy engines (Kyverno / OPA Gatekeeper) — обзор](#-3-policy-engines-kyverno--opa-gatekeeper--)
  - [Теория для изучения перед частью](#----)
- [Часть 4: Troubleshooting](#-4-troubleshooting)
  - [Теория: порядок admission-конвейера (что за чем выполняется)](#--admission-----)
  - [Теория: как читать отказ admission (кто именно отклонил)](#----admission---)
  - [Инцидент 1: под отклонён PSA (restricted)](#-1---psa-restricted)
  - [Инцидент 2: легитимный под не создаётся из-за VAP](#-2-------vap)
  - [Инцидент 3: PSA «не срабатывает»](#-3-psa--)
- [Проверка модуля](#-)
