...
- [Стартовая проверка](#-)
- [Часть 1: HPA по CPU-утилизации](#-1-hpa--cpu-)
  - [Теория для изучения перед частью](#----)
  - [1.1 Deployment + HPA](#11-deployment--hpa)
- [Часть 2: Нагрузка и масштабирование](#-2---)
  - [Теория для изучения перед частью](#----)
  - [2.1 Scale-up под нагрузкой](#21-scale-up--)
  - [2.2 Scale-down после снятия нагрузки](#22-scale-down---)
...
- [Часть 4: Troubleshooting](#-4-troubleshooting)
  ...
  - [Инцидент 3: scale-up есть, но поды `Pending`](#-3-scale-up----pending)
- [Проверка модуля](#-)
...
- Настройке горизонтального автомасштабирования (HPA)
