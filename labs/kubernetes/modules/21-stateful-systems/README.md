...
- [Стартовая проверка](#-)
- [Часть 1: Эволюция баз данных в Kubernetes (Теория)](#-1)
  - [Теория для изучения перед частью](#-1-theory)
  - [1.1 Почему StatefulSet недостаточно](#11-statefulset)
  - [1.2 Паттерн Operator (CRD + Controller)](#12-operator)
  - [1.3 Архитектура CloudNativePG](#13-cloudnativepg)
- [Часть 2: Развёртывание PostgreSQL кластера](#-2)
  - [Теория для изучения перед частью](#-2-theory)
  - [2.1 Bootstrap кластера](#21-bootstrap)
  - [2.2 Подключение к БД и маршрутизация](#22-routing)
- [Часть 3: High Availability и Failover (Переключение мастера)](#-3)
  - [Теория для изучения перед частью](#-3-theory)
  - [3.1 Имитация сбоя Primary узла](#31-failover)
  - [3.2 Кворум и предотвращение Split-Brain](#32-split-brain)
- [Часть 4: Бэкапы, Архивация WAL и Восстановление (PITR)](#-4)
  - [Теория для изучения перед частью](#-4-theory)
  - [4.1 Запуск резервного копирования по расписанию](#41-scheduledbackup)
  - [4.2 Point in Time Recovery (PITR)](#42-pitr)
- [Часть 5: Масштабирование и Rolling Upgrade (Обновление версии)](#-5)
  - [Теория для изучения перед частью](#-5-theory)
  - [5.1 Scale Out (Read Replicas)](#51-scale)
  - [5.2 Обновление версии без простоя](#52-upgrade)
- [Часть 6: Управление подключениями (Connection Pooling)](#-6)
  - [Теория для изучения перед частью](#-6-theory)
  - [6.1 Настройка Pooler (PgBouncer)](#61-pooler)
- [Часть 7: Troubleshooting — боевые инциденты](#-7)
  - [Теория для изучения перед частью](#-7-theory)
  - [Инцидент 1: Под БД в `CrashLoopBackOff` (Нехватка ресурсов)](#-1-crashloop)
  - [Инцидент 2: Оператор упал, Failover не работает](#-2-operator-down)
  - [Инцидент 3: Ошибка при создании бэкапа (Креды S3)](#-3-backup-error)
- [Финальная карта ресурсов модуля](#-)
- [Теоретические вопросы (итоговые)](#-)
  - [Блок 1: StatefulSet vs Operator](#-1)
  - [Блок 2: CloudNativePG кластер](#-2)
  - [Блок 3: HA & Failover](#-3)
  - [Блок 4: Бэкапы и Восстановление](#-4)
  - [Блок 5: Troubleshooting](#-5)
- [Чему вы научились](#-)
- [Проверка модуля](#-)
- [Уборка](#-)
