...
Практический репозиторий для поэтапного освоения Kubernetes. Содержит 28 учебных модулей и 5 итоговых проектов (capstone) для закрепления материала на живом кластере.
