...
## Оглавление
<!-- TOC -->
- [Чек-лист прод-готовности (11 критериев)](#чек-лист-прод-готовности-11-критериев)
- [Предварительные требования](#предварительные-требования)
- [Стартовая проверка](#стартовая-проверка)
- [Часть 1: Аудит «наивного» приложения (ДО)](#часть-1-аудит-наивного-приложения-до)
- [Часть 2: Харденинг до прод-готовности (ПОСЛЕ)](#часть-2-харденинг-до-прод-готовности-после)
- [Аудит-инструмент (`audit/audit.sh`)](#аудит-инструмент-auditauditsh)
- [Проверка](#проверка)
...
> ⏱ время ~60 мин · сложность 4/5 · пререквизиты: Трек 1 и Трек 3

<!-- NAV -->
**⬅ [project-b-stateful-service](../project-b-stateful-service/)** · [индекс курса](../../README.md) · [карта обучения](../../docs/02-learning-path.md) · **[project-e-secure-platform](../project-e-secure-platform/) ➡**
<!-- /NAV -->
