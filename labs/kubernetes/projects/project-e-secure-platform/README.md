...
## Оглавление
<!-- TOC -->
- [Архитектура изоляции](#архитектура-изоляции)
- [Предварительные требования](#предварительные-требования)
- [Стартовая проверка](#стартовая-проверка)
- [Развёртывание](#развёртывание)
- [Доказательства изоляции (5 проверок)](#доказательства-изоляции-5-проверок)
  - [1. PSA: небезопасный под отклоняется](#1-psa-небезопасный-под-отклоняется)
  - [2. policy-as-code (VAP): `:latest` запрещён — НО только у тенантов](#2-policy-as-code-vap-latest-запрещён--но-только-у-тенантов)
  - [3. RBAC: тенант управляет ТОЛЬКО своим namespace](#3-rbac-тенант-управляет-только-своим-namespace)
  - [4. ResourceQuota: нельзя выйти за лимиты](#4-resourcequota-нельзя-выйти-за-лимиты)
  - [5. NetworkPolicy: тенанты не видят друг друга по сети](#5-networkpolicy-тенанты-не-видят-друг-друга-по-сети)
- [Аудит изоляции (переиспользуемый гейт)](#аудит-изоляции-переиспользуемый-гейт)
- [Проверка проекта](#проверка-проекта)
- [Карта ресурсов](#карта-ресурсов)
...
> ⏱ время ~90 мин · сложность 5/5 · пререквизиты: Трек 1, 3 и 4

<!-- NAV -->
**⬅ [project-d-production-readiness](../project-d-production-readiness/)** · [индекс курса](../../README.md) · [карта обучения](../../docs/02-learning-path.md) · **[project-c-broken-cluster-lab](../project-c-broken-cluster-lab/) ➡**
<!-- /NAV -->
